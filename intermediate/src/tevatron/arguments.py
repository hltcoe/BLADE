...
class ModelArguments:
    ...
    decoder_weights: Optional[str] = field(
        default=None, metadata={"help": "Location to custom decoder weights"}
    )
    # modeling
    ...
    freeze_layers: bool = field(default=False)
    projection_in_dim: int = field(default=768)
    projection_out_dim: int = field(default=768)
    lambda_q: float = field(default=0.0008)
    lambda_d: float = field(default=0.0006)
    vocab_size: int = field(default=30522)
    top_k: int = field(default=405)
    vocab_decay: int = field(default=10000)
    sparse_step: int = field(default=50000)
...
class DataArguments:
    ...
    vocab_mask: str = field(default=None, metadata={"help": "where to save the encode"})
    doc_lang: str = field(default=None, metadata={"help": "where to save the encode"})
    q_distil: str = field(default=None, metadata={"help": "where to save the encode"})
    p_distil: str = field(default=None, metadata={"help": "where to save the encode"})
    p_offset: str = field(default=None, metadata={"help": "where to save the encode"})
