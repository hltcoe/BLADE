...
class DenseTrainer(Trainer):
    ...
    def compute_loss(self, model, inputs):
        query, passage, teacher_query, teacher_passage = inputs
        return model(query=query, passage=passage, teacher_query=teacher_query, teacher_passage=teacher_passage).loss

    def training_step(self, *args):
        return super(DenseTrainer, self).training_step(*args) / self._dist_loss_scale_factor

    def create_sparse_scheduler(num_training_steps, optimizer):
        return
